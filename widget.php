...
function popular_terms_control()
{
    ...
    <p>
		...
		<ul><li><Input type="radio" name="popularterms-widgetlist" value="1" <?php if (1 == $options['list']) {
        echo 'checked';
    } ?> /> List</li>
		<li><Input type="radio" name="popularterms-widgetlist" value="0" <?php if (0 == $options['list']) {
        echo 'checked';
    } ?> /> Comma separated value</li></ul>	</p><p>
		<label>Link to search (not recommended):</label> 
		<Input type="radio" name="popularterms-widgetsearch" value="0" <?php if (0 == $options['search']) {
        echo 'checked';
    } ?> />No&nbsp;&nbsp;		
		<Input type="radio" name="popularterms-widgetsearch" value="1" <?php if (1 == $options['search']) {
        echo 'checked';
    } ?> />Yes
	</p><p>
...
function recent_terms_control()
{
    ...
    <p>
		...
		<label>Display format:</label> 
		<ul><li><Input type="radio" name="recentterms-widgetlist" value="1" <?php if (1 == $options['list']) {
        echo 'checked';
    } ?> /> List </li>
		<li><Input type="radio" name="recentterms-widgetlist" value="0" <?php if (0 == $options['list']) {
        echo 'checked';
    } ?> /> Comma separated value</li></ul>	
		</p><p>
		<label>Link to search (not recommended):</label> 
		<Input type="radio" name="recentterms-widgetsearch" value="0" <?php if (0 == $options['search']) {
        echo 'checked';
    } ?> />No&nbsp;&nbsp;		
		<Input type="radio" name="recentterms-widgetsearch" value="1" <?php if (1 == $options['search']) {
        echo 'checked';
    } ?> />Yes
	</p><p>
...
function popular_terms_cat_control()
{
    ...
    <p>
		...
		<label>Display format:</label> 
		<ul><li><Input type="radio" name="populartermscat-widgetlist" value="1" <?php if (1 == $options['list']) {
        echo 'checked';
    } ?> /> List</li>
		<li><Input type="radio" name="populartermscat-widgetlist" value="0" <?php if (0 == $options['list']) {
        echo 'checked';
    } ?> /> Comma separated value</li></ul>		
			</p><p>
		<label>Link to search (not recommended):</label> 
		<Input type="radio" name="populartermscat-widgetsearch" value="0" <?php if (0 == $options['search']) {
        echo 'checked';
    } ?> />No&nbsp;&nbsp;		
		<Input type="radio" name="populartermscat-widgetsearch" value="1" <?php if (1 == $options['search']) {
        echo 'checked';
    } ?> />Yes
	</p><p>
...
function pk_random_terms_control()
{
	...
	<p>
		<label>Display format:</label> 
		<ul><li><Input type="radio" name="randomterms-widgetlist" value="1" <?php if (1 == $options['list']) {
        echo 'checked';
    } ?> /> List</li>
		<li><Input type="radio" name="randomterms-widgetlist" value="0" <?php if (0 == $options['list']) {
        echo 'checked';
    } ?> /> Comma separated value</li></ul>	
	</p>
	<p>
		<label>Link to search (not recommended):</label> 
		<Input type="radio" name="randomterms-widgetsearch" value="0" <?php if (0 == $options['search']) {
        echo 'checked';
    } ?> />No&nbsp;&nbsp;		
		<Input type="radio" name="randomterms-widgetsearch" value="1" <?php if (1 == $options['search']) {
        echo 'checked';
    } ?> />Yes
	</p>
		<p>
